  ...
  return (
    <header className="bg-bg-header border-b border-border px-4 py-3 flex items-center justify-between drag-region">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="font-semibold text-text-primary">Prehraj.to AutoPilot</h1>
          <p className="text-xs text-text-muted">Automatizace stahování a nahrávání</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 no-drag">
        ...
        <button className="p-2 hover:bg-bg-hover rounded-lg transition-colors" title="Nastavení">
          <svg className="w-5 h-5 text-text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button className="p-2 hover:bg-bg-hover rounded-lg transition-colors" title="Minimalizovat">
          <svg className="w-5 h-5 text-text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
