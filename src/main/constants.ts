...
export const WORKER_DOWNLOAD_PATH = '../workers/download.worker.cjs'
export const WORKER_UPLOAD_PATH = '../workers/upload.worker.cjs'
export const WORKER_DISCOVER_PATH = '../workers/discover.worker.cjs'
export const WORKER_MYVIDEOS_PATH = '../workers/myvideos.worker.cjs'
export const WORKER_SESSION_PATH = '../workers/session.worker.cjs'
